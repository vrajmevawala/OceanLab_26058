...
3. REDUNDANCY & INEFFICIENCIES: Identify redundant computations, dead code, duplicate logic, boilerplate, and suggest DRY patterns.
4. LOOP INEFFICIENCIES: Explicitly look for inefficient loops, nested loops, and redundant operations inside loops.
`.trim();
...
export function buildAnalysisUserPrompt(
  ...
  return `
Analyze this ${language} code for redundant computations, dead code, loop inefficiencies, complexity, and architectural improvements.
